...
if __name__ == '__main__':
    ...
    # }
    record = {
        "comp_title": "全球数据智能大赛(2020) today comp ",
        "comp_subtitle": "“数字人体”赛场一：肺部CT多病种智能诊断",
        "comp_range": "Jul 31 - Oct 31, 2019",
        "comp_url": "https://tianchi.aliyun.com/competition/entrance/231724/",
        "comp_description": "赛场一“数字人体”挑战赛以肺部CT多病种智能诊断为课题，开放高质量CT标注数据，要求选手提出并综合运用目标检测、深度学习等人工智能算法，识别肺结节、索条（条索状影）、动脉硬化或钙化、淋巴结钙化等多个病种，避免同一部位单病种的反复筛查，提高检测的速度和精度，辅助医生进行诊断。",
        "comp_host": "[{'comp_host_name': '天池', 'comp_host_url': 'https://tianchi.aliyun.com/home/'}, {'comp_host_name': '天池2', 'comp_host_url': 'https://tianchi.aliyun.com/'}]",
        "prize_currency": "RMB",
        "prize_amount": "11000",
        "publish_time": "2019-07-23",
        "update_time": "2019-08-01",
        "deadline": "2019-09-01 13:59:59",
        "timezone": "UTC",
        "comp_scenario": "['CV', 'RL']",
        "data_feature": "['一维数组', '二维数组']",
        "contributor_id": "233"
    }    

    result = requests.post("http://45.78.76.192:30600/api/competition",
                           data=record)
